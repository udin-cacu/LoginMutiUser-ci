...
class Menu extends CI_Controller
{
    ...
    public function accessmenu()
    {
        ...
        $data['accessMenu'] = $this->menu->getAccessMenu();
        $data['menu'] = $this->db->get('user_menu')->result_array();
        ...
        if ($this->form_validation->run() ==  false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('menu/accessmenu', $data);
            $this->load->view('templates/footer');
        } else {
            $data = [
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">New access menu added!</div>');
